...
from data_fox.widgets import DynamicFields, PathChooser
...
class RequestArea(Static):
    ...
    def compose(self) -> ComposeResult:
        with TabbedContent('Headers', 'Query params', 'Body'):
            yield DynamicFields(id='headers-fields')
            yield DynamicFields(id='query-params-fields')
    ...
    def on_mount(self) -> None:
        ...
        self.body_editor: TextArea = self.query_one('#body-editor')
    ...
    def change_body_type(self, message: Select.Changed) -> None:
